...
@SystemMessage(
    ...
    Analise este exame de T4 Livre (também chamado de Tiroxina Livre) em português e extraia as seguintes informações no formato JSON:
    {
      "t4Livre": 0.0,
...
@RegisterAiService(modelName = "t4-livre")
public interface T4LivreIAService extends DocumentExtractDataIAService {
    @UserMessage(
        """
