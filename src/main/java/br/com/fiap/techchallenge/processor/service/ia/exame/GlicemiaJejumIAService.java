...
@SystemMessage(
    ...
    Analise este exame de glicemia de jejum em português e extraia as seguintes informações no formato JSON:
    {
      "glicose": 0.0,
...
@RegisterAiService(modelName = "glicemia-jejum")
public interface GlicemiaJejumIAService extends DocumentExtractDataIAService {
    @UserMessage(
        """
    ...
    @Override
    GlicemiaJejumExameEntity extractData(Image image);
}
