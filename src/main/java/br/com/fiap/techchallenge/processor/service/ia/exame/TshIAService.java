...
@SystemMessage(
    ...
    Analise este exame de TSH (Hormônio Tireoestimulante) em português e extraia as seguintes informações no formato JSON:
    {
      "tshBasal": 0.0,
...
@RegisterAiService(modelName = "tsh")
public interface TshIAService extends DocumentExtractDataIAService {
    @UserMessage(
        """
    ...
    @Override
    TshExameEntity extractData(Image image);
}
