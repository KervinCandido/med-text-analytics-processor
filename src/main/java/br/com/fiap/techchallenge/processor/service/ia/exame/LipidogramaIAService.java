...
@SystemMessage(
    ...
    Analise este lipidograma (perfil lipídico) em português e extraia as seguintes informações no formato JSON:
    {
      "colesterolTotal": 0.0,
      "triglicerideos": 0.0,
      "colesterolHdl": 0.0,
...
@RegisterAiService(modelName = "lipidograma")
public interface LipidogramaIAService extends DocumentExtractDataIAService {
    @UserMessage(
        """
